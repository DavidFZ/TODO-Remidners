...
public class LeftSideView {
    public static void main(String[] args) {
...

        {
            ...
            //TODO: refactor this
            List<Reminder> flaggedList = queryReminderByEmergencyStatus(true);
            stringNumberOfFlagged = new JLabel(String.valueOf(flaggedList.size()));
            stringNumberOfFlagged.setFont(getBoldFont(16));
            stringNumberOfFlagged.setForeground(Color.red);
            ...
            flaggedPanel.add(stringNumberOfFlagged);
